			...
			<CoustomRouter history={history}>
				...
				<Routes>
					<Route
						path="/"
						exact
						element={<ProductList open={open} setOpen={setOpen} />}
					/>
					...
					<Route
						...
						exact
						element={<StockEdit id={() => getIdForStock()} />}
					/>
					<Route path="/admin/archive" exact element={<Archive />} />
					<Route
						path="/admin/archive/:id"
						exact
						element={<ArcShow id={() => getIDForEdit()} />}
					/>
					<Route path="/admin/aproved" exact element={<Aproved />} />
					<Route
						path="/admin/aproved/:id"
						exact
						element={<AprovedShow id={() => getIDForEdit()} />}
					/>
					<Route
						path="/admin/aproved/delete/:id"
						exact
						element={<AprovedDelete id={() => getIdForAprDel()} />}
					/>
					<Route
						path="/admin/requests"
						exact
					...
					<Route
						...
						exact
						element={<ReqShow id={() => getIdforShowReq()} />}
					/>
					<Route
						path="/admin/requests/delete/:id"
						exact
						element={<ReqDelete id={() => getIdforDelReq()} />}
					/>
					<Route path="/cart" exact element={<Cart />} />
					<Route
						path="/products/delete/:id"
						exact
						element={<DeleteProduct id={() => getIDForDelete()} />}
					/>
					<Route
						path="/products/edit/:id"
						exact
						element={<EditProduct id={() => getIDForEdit()} />}
					/>
					<Route
						path="/products/add"
						exact
